            ...
            for (int TrajIndex = 0; TrajIndex < PublicData.TrajCount; TrajIndex++)
            {
                ...
                for (int i = 0; i < TrajInform[TrajIndex].PointCount[0]; i++)
                {
                        ...
                        if (!TrajInform[TrajIndex].Before[i])
                        {
                            ...
                            SoapInstance.SoapWrite.MoveJ(TrajInform[TrajIndex].Beforepoint[i], TrajInform[TrajIndex].BeforePara[i][0] * PublicData.Speed, TrajInform[TrajIndex].BeforePara[i][1]);
                        }
                        else
                        {
                            //SoapInstance.SoapWrite.Movel()
                         //   SoapInstance.SoapWrite.MoveL(TrajInform[TrajIndex].Beforepoint[i], TrajInform[TrajIndex].BeforePara[i][0] * PublicData.Speed, TrajInform[TrajIndex].BeforePara[i][1]);
                            //SoapInstance.SoapWrite.MoveL(TrajInform[TrajIndex].Beforepoint[i], TrajInform[TrajIndex].BeforePara[i][0] * PublicData.Speed, TrajInform[TrajIndex].BeforePara[i][1]);
                            SoapInstance.SoapWrite.MoveL(TrajInform[TrajIndex].Beforepoint[i], PublicData.Tcp, TrajInform[TrajIndex].TrajFrame, TrajInform[TrajIndex].BeforePara[i][0] * PublicData.Speed, TrajInform[TrajIndex].BeforePara[i][1], 0);
                        }
                ...
                for (int i = 0; i < TrajInform[TrajIndex].PointCount[1]; i++)
                {
                        ...
                        {
                            SoapInstance.SoapWrite.MoveC(TrajInform[TrajIndex].Midpoint[i], TrajInform[TrajIndex].MidMC[i], TrajInform[TrajIndex].MidPara[i][0] * PublicData.Speed, TrajInform[TrajIndex].MidPara[i][1]);
                        }
                        else
                        {
                            SoapInstance.SoapWrite.MoveL(TrajInform[TrajIndex].Midpoint[i], TrajInform[TrajIndex].MidPara[i][0] * PublicData.Speed, TrajInform[TrajIndex].MidPara[i][1]);
                        }
                ...
                for (int i = 0; i < TrajInform[TrajIndex].PointCount[2]; i++)
                {
                        ...
                        {
                            SoapInstance.SoapWrite.MoveJ(TrajInform[TrajIndex].Afterpoint[i], TrajInform[TrajIndex].AfterPara[i][0] * PublicData.Speed, TrajInform[TrajIndex].AfterPara[i][1]);
                        }
                        else
                        {
                            SoapInstance.SoapWrite.MoveL(TrajInform[TrajIndex].Afterpoint[i], TrajInform[TrajIndex].AfterPara[i][0] * PublicData.Speed, TrajInform[TrajIndex].AfterPara[i][1]);
                        }
    ...
    TrajInform[TrajIndex].TrajFrame[3].ToString() + "," + TrajInform[TrajIndex].TrajFrame[4].ToString() + "," + TrajInform[TrajIndex].TrajFrame[5].ToString();    
        ...
        private void BT_SetOK_Click(object sender, EventArgs e)
        {
          ...
          //  Las=!Las;
            ...
            SoapInstance.SoapWrite.SoapSetAppname = "Disk://helloio/helloio.pjx";
            SoapInstance.SoapWrite.SetAppdata("nnum",double.Parse(TB_SetPower.Text.Trim()));
            a++;
